...
impl SvcLoad {
    ...
    // repeated .SvcLoad.CompositeBindsEntry composite_binds = 4;
...
impl ::protobuf::Message for SvcLoad {
    ...
    fn compute_size(&self) -> u32 {
        ...
        my_size += ::protobuf::rt::compute_map_size::<::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<ServiceBindList>>(4, &self.composite_binds);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        ::protobuf::rt::write_map_with_cached_sizes::<::protobuf::types::ProtobufTypeString, ::protobuf::types::ProtobufTypeMessage<ServiceBindList>>(4, &self.composite_binds, os)?;
        if let Some(v) = self.specified_binds {
            os.write_bool(5, v)?;
        }
        if let Some(ref v) = self.bldr_url.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\tctl.proto\x1a\x0btypes.proto\"9\n\x0bNetProgress\x12\x14\n\x05total\
    \x18\x01\x20\x01(\x04R\x05total\x12\x14\n\x05delta\x18\x02\x20\x01(\x04R\
    \x05delta\"&\n\tHandshake\x12\x19\n\x08auth_key\x18\x01\x20\x01(\tR\x07a\
    uthKey\"5\n\x0fServiceBindList\x12\"\n\x05binds\x18\x01\x20\x03(\x0b2\
    \x0c.ServiceBindR\x05binds\"7\n\x10SvcGetDefaultCfg\x12#\n\x05ident\x18\
    \x01\x20\x01(\x0b2\r.PackageIdentR\x05ident\"\x92\x05\n\x07SvcLoad\x12#\
    \n\x05ident\x18\x01\x20\x01(\x0b2\r.PackageIdentR\x05ident\x12P\n\x17app\
    lication_environment\x18\x02\x20\x01(\x0b2\x17.ApplicationEnvironmentR\
    \x16applicationEnvironment\x12\"\n\x05binds\x18\x03\x20\x03(\x0b2\x0c.Se\
    rviceBindR\x05binds\x12E\n\x0fcomposite_binds\x18\x04\x20\x03(\x0b2\x1c.\
    SvcLoad.CompositeBindsEntryR\x0ecompositeBinds\x12'\n\x0fspecified_binds\
    \x18\x05\x20\x01(\x08R\x0especifiedBinds\x12\x19\n\x08bldr_url\x18\x06\
    \x20\x01(\tR\x07bldrUrl\x12!\n\x0cbldr_channel\x18\x07\x20\x01(\tR\x0bbl\
    drChannel\x12\x1f\n\x0bconfig_from\x18\x08\x20\x01(\tR\nconfigFrom\x12\
    \x1b\n\x05force\x18\t\x20\x01(\x08:\x05falseR\x05force\x12\x14\n\x05grou\
    p\x18\n\x20\x01(\tR\x05group\x124\n\x16svc_encrypted_password\x18\x0b\
    \x20\x01(\tR\x14svcEncryptedPassword\x12%\n\x08topology\x18\x0c\x20\x01(\
    \x0e2\t.TopologyR\x08topology\x128\n\x0fupdate_strategy\x18\r\x20\x01(\
    \x0e2\x0f.UpdateStrategyR\x0eupdateStrategy\x1aS\n\x13CompositeBindsEntr\
    y\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12&\n\x05value\x18\x02\
    \x20\x01(\x0b2\x10.ServiceBindListR\x05value:\x028\x01\"0\n\tSvcUnload\
